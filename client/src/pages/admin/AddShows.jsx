  ...
  return nowPlayingMovies.length>0 ?(
    <> 
            ...
            {nowPlayingMovies.map((movie)=>(
                ...
                `}>
                   ...
                   {selectedMovie===movie.id && (
                    <div className='absolute top-2 flex items-center justify-center bg-primary h-6 w-6 rounded'>
      ...
      <div className='mt-8'>
        ...
        <div className='inline-flex items-center gap-3 border border-gray-600 px-3 py-2 rounded-m'>
